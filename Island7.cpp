...
void MyList::setHead(MyNode* temp)
{
    head = temp;
}
...
void Island::changePosition(int v1) {
    this->previousLocation = v1;
}

MyNode* Island::_getHead()
{
    return listStart.getHead();
}
...
//-------------------------------------
void MyQueue::insert(int v1)
{    
    MyNode* temp = new MyNode(v1);
